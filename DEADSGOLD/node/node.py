...
def mine():
    ...
    proof = blockchain.miner.mine(last_block, blockchain.pending_transactions, blockchain.difficulty)
    ...
    blockchain.new_transaction(
        Transaction(
            sender="0",
            recipient=blockchain.miner.wallet.public_key, # Assuming miner has a wallet
            amount=1,
        )
    )
